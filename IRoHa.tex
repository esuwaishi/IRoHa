...
\begin{tcolorbox}[title=\textgt{SuperKEKBのシンクロトロン周波数}, breakable = true]
  ...
  \begin{equation}
    \gamma = \frac{E_s}{E_0}, \; \eta = \alpha_p - \frac{1}{\gamma^2} , \; \beta = \sqrt{1-\frac{1}{\gamma^2}} \notag
  \end{equation}
  %
  ...
  %
  \begin{equation}
    f_s = \sqrt{\frac{e Vc h \eta f_{rev}^2 \cos \phi_s}{2\pi \beta_s E_s}} = \SI{2.438}{\kilo\hertz}\notag
  \end{equation}
  %
  また、LERのシンクロトロン・チューン$\nu_s$は
  %
