...
%
\begin{equation}
  \ddot{\phi} = \frac{h\omega_{rev}^2 e V \eta}{2\pi\beta_s^2 E_s}(\sin\phi-\sin\phi_s)
  \label{ddot_phi}
\end{equation}
%
...
%
\begin{equation}
  \ddot{\Delta\phi} = \frac{h \omega_{rev}^2 e V \eta}{2\pi \beta_s^2 E_s} \cos\phi_s \Delta\phi = - \omega_s^2 \Delta\phi
\end{equation}
%
となり、この運動は$\phi_s$の周りの単振動であることが分かる。また、この振動の振動数$\omega_s$は
%
\begin{equation}
  \omega_s = \omega_{rev} \sqrt{-\frac{h e V \eta }{2\pi \beta_s^2 E_s} \cos\phi_s}
\end{equation}
%
